...
[MDP4002](/reference/analyzers/#mdp4002). Let the host choose the port.
...
[what to expect at shutdown](/reference/plugin-hosting/#what-to-expect-at-shutdown), which covers the sequence -
...
- [Plugin hosting](/reference/plugin-hosting/) - the builder, the reserved routes, and the full shutdown
  sequence.
...
- [Analyzers](/reference/analyzers/) - MDP4002 and the rest.
