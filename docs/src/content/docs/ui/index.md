...
modal dialog - see [Views and surfaces](/ui/views/). What differs by surface is layout and available
...
[component reference](/ui/components/) for the full catalog.
...
- **[Views](/ui/views/)** - the surfaces a tree renders on: sessions, configuration, deck widgets,
