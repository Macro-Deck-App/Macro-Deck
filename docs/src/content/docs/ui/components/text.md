...
data rather than theme - see [Colours and text](/ui/concepts/theming/) for the full split and for why
...
them out of the box. See [Sizing](/ui/concepts/sizing/) for the full length model.
