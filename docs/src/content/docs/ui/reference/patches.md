...
[what a refused update looks like](/ui/views/sessions/#what-a-refused-update-looks-like) for the
...
the minimal patch for you from a state change - see [Reactive updates](/ui/concepts/reactive-updates/).
