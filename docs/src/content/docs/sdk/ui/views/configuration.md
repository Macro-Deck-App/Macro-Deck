...
field list to fall back to: a folder's selected view (see [Folder views](/sdk/folder-views/)) and a
widget (see [Configuring a widget](/sdk/ui/views/widget-configuration/)).
