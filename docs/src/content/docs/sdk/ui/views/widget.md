...
to the framework and is covered in full under [Components](/sdk/ui/components/); this page is where
...
`IUiProvider` - see [Widget types](/sdk/widgets/), which covers registration, the picker card and
...
The same vocabulary draws a [folder view](/sdk/folder-views/) and an action modal, both of which a plugin
can serve too.
