...
See [Localization](/sdk/localization/) for the resource catalogs `LocalizedString` draws from, and
[Resources](/sdk/ui/reference/resources/) for how a `FontFace` identifier differs from a `UiResource`
handle.
