...
[Colours and text](/sdk/ui/concepts/theming/). Its absent meaning is spelled by omitting the key rather
...
control that does not move. See [Events](/sdk/ui/concepts/events/) for the shared interaction model.
