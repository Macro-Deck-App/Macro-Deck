...
`MacroDeck.Plugin.Testing.Conformance`, built on the same `MacroDeckTestHost` the [Testing plugins guide](/sdk/testing/)
...
- [Testing plugins](/sdk/testing/) - `MacroDeck.Plugin.Testing`, the package this suite is built on.
