...
[registration modes](/sdk/hosting/#registration-modes) for the full environment-variable table.
...
failure is fatal. See [what the SDK does for you](/sdk/hosting/#what-the-sdk-does-for-you).
...
- [Plugin hosting](/sdk/hosting/) - the registration modes and the environment the supervisor
  injects.
