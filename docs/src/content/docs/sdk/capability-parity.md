...
For exact operation/message fields use the [plugin protocol](/reference/protocol/) and machine-readable specifications. For capability semantics use [Capabilities](/sdk/capabilities/).
