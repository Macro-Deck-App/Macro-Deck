...
[`IUiProvider`](/sdk/ui/views/sessions/) to serve them:
...
A folder view is built from [Macro Deck UI components](/sdk/ui/components/) - the same `ui.stack`,
...
[configuration view](/sdk/ui/views/configuration/); the values the user enters are stored
...
[Layout providers](/sdk/layouts/). A profile no device claims keeps the choice.
...
- [Macro Deck UI](/sdk/ui/) - the component model a folder view is built from.
- [Capabilities](/sdk/capabilities/) - how `folder-view-provider` is declared.
- [Layout providers](/sdk/layouts/) - the same registration shape, one level down.
