...
hardware, and a [device provider](/sdk/devices/) points a device at one through the existing
...
[device providers](/sdk/devices/#capabilities-and-layouts) already use. The sample above shows the whole
...
show a [folder view](/sdk/folder-views/) - a Macro Deck UI tree standing in for the widget grid - at all.
...
[Capabilities](/sdk/capabilities/#layout-providers) for the exact operations and
[Capability parity](/sdk/capability-parity/) for plugin-specific behaviour.
