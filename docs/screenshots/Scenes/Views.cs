...
internal static partial class Scenes
{
	...
	private static IEnumerable<Scene> ViewScenes()
	{
						...
						[
							new UiStack
							{
								...
								[
									new UiTextRun
									{
										Key = "location", Text = "Berlin", Size = 0.09,
										Weight = UiComponentTextWeights.SemiBold
									},
									new UiTextRun
									{
										Key = "temp", Text = "21°", Size = 0.26, Weight = UiComponentTextWeights.Bold
									},
								],
							},
		...
		yield return Tile("view-widget-type",
			new UiLayer
			{
				Key = "gaugeTile",
				Children =
				[
					...
					new UiStack
					{
						...
						[
							new UiTextRun
							{
								Key = "reading", Text = "70 km/h", Size = 0.09, Role = UiComponentTextRoles.Secondary
							}
						],
					},
				],
		...
		yield return Dialog("view-modal",
			new UiList
			{
				Key = "devices",
				...
				Children =
				[
					.. devices.Select(device => new UiButton
					{
						Key = device.Id,
						Direction = UiComponentDirections.Horizontal,
						Align = UiComponentAlignments.Center,
						...
						[
							...
							new UiStack
							{
								...
								[
									new UiTextRun
									{
										Key = "name", Text = device.Name, Size = UiSize.FromBasis(0.038),
										Weight = UiComponentTextWeights.Medium
									},
									new UiTextRun
									{
										Key = "detail", Text = device.Detail, Size = UiSize.FromBasis(0.03),
