...
internal static partial class Scenes
{
	private static IEnumerable<Scene> SliderScenes()
	{
		...
		yield return Tile("slider-vertical",
			new UiStack
			{
				Key = "tile",
	...
	private static IEnumerable<Scene> RangeBarScenes()
	{
		...
		yield return Tile("range-bar-marker",
			new UiStack
			{
				Key = "forecast",
				...
				[
					.. days.Select(day => new UiStack
					{
						...
						[
							...
							new UiTextRun
							{
								Key = "low", Text = day.Low, Size = 0.09, MainSize = 0.14,
								Role = UiComponentTextRoles.Secondary, Align = UiComponentAlignments.End
							},
							new UiRangeBar
							{
								Key = "bar",
