...
internal static partial class Scenes
{
		...
		[
			new UiStack
			{
				...
				[
					...
					new UiTextRun { Key = "time", Text = "14:05", Size = 0.1, MainSize = 0.3, Align = UiComponentAlignments.End, Role = UiComponentTextRoles.Secondary },
				],
			},
			...
			new UiTextRun { Key = "caption", Text = "Humidity 48 %", Size = UiSize.Capped(0.1, 12 * Scale), Role = UiComponentTextRoles.Secondary },
		],
	};
	...
	private static UiStack StatusCard() => new()
	{
		...
		[
			...
			new UiSlider { Key = "level", Level = 0.6, MainSize = 0.16, Thickness = UiSize.FromBasis(0.06), Events = [UiEventHandler.On(UiComponentEvents.Change, () => { })] },
		],
	};
