...
export {
  ...
  type CompanionAppConnectedApp,
  type CompanionAppDevice,
  type CompanionAppDeviceState,
  type CompanionAppError,
  type CompanionAppStatus,
  type InstallCompanionAppResponse,
