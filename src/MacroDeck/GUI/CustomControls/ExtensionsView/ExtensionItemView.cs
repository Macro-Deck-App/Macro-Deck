...
public partial class ExtensionItemView : RoundedUserControl
{
    ...
    public ExtensionItemView(IMacroDeckExtension macroDeckExtension, bool updateAvailable)
    {
        ...
        btnConfigure.Visible
            = macroDeckExtension.Configurable || macroDeckExtension.GetType() == typeof(IconPackExtension);
        ...
        switch (macroDeckExtension.ExtensionType)
        {
            case ExtensionType.Plugin:
                ...
                extensionIcon.BackgroundImage
                    = macroDeckPlugin.PluginIcon == null ? Resources.Icon : macroDeckPlugin.PluginIcon;
