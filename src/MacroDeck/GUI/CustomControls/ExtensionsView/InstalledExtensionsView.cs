...
public partial class InstalledExtensionsView : UserControl
{
	...
	public void ListInstalledExtensions()
	{
		...
		foreach (var macroDeckPlugin in PluginManager.Plugins.Values)
		{
			...
			var extensionItemView = new ExtensionItemView(new PluginExtension(macroDeckPlugin),
		...
		{
			var extensionItemView = new ExtensionItemView(new IconPackExtension(iconPack),
