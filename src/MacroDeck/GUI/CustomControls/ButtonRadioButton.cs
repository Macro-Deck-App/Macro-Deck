...
public partial class ButtonRadioButton : RadioButton
{
    ...
    protected override void OnPaint(PaintEventArgs pe)
    {
        ...
        var iconSurface = new Rectangle(rectSurface.X + Margin.Left,
            rectSurface.Y + Margin.Top,
            rectSurface.Height - Margin.Top - Margin.Bottom,
            rectSurface.Height - Margin.Top - Margin.Bottom);
        switch (_iconAlignment)
        {
            ...
            case ContentAlignment.BottomLeft:
                iconSurface = new Rectangle(rectSurface.X + Margin.Left,
                    rectSurface.Y + Margin.Top,
                    rectSurface.Height - Margin.Top - Margin.Bottom,
                    rectSurface.Height - Margin.Top - Margin.Bottom);
                break;
            ...
            case ContentAlignment.BottomCenter:
                iconSurface = new Rectangle(
                    rectSurface.X + Width / 2 - (rectSurface.Height - Margin.Top - Margin.Bottom) / 2,
                    rectSurface.Y + Margin.Top,
                    rectSurface.Height - Margin.Top - Margin.Bottom,
                    rectSurface.Height - Margin.Top - Margin.Bottom);
                break;
