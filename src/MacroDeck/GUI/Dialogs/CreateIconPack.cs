...
public partial class CreateIconPack : DialogForm
{
    ...
    private void BtnOk_Click(object sender, EventArgs e)
    {
        ...
        if (IconManager.GetIconPackByName(iconPackName.Text) != null)
        {
            ...
            messageBox.ShowDialog(LanguageManager.Strings.CantCreateIconPack,
                string.Format(LanguageManager.Strings.IconPackCalledXAlreadyExists, iconPackName.Text),
