...
namespace SuchByte.MacroDeck.InternalPlugins.FolderPlugin.GUI;
...
public partial class FolderSwitcherConfigurator : ActionConfigControl
{
    ...
    {
        if (ProfileManager.CurrentProfile.Folders == null)
        {
            return;
        }
    ...
    public override bool OnActionSave()
    {
        ...
        var folder = ProfileManager.FindFolderByDisplayName(foldersView.SelectedNode.Text,
