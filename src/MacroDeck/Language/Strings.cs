...
public class Strings
{
	...
	public string MacroDeckMustBeRestartedForTheChanges
		= "Macro Deck must be restarted for the changes to take effect. Would you like to restart Macro Deck now?";
	...
	public string InitialSetupDontWorryInstallUninstallPlugins
		= "Don't worry, you can always install/uninstall plugins later in the package manager";

	public string InitialSetupWantSomeIcons = "Do you want some icons?";

	public string InitialSetupInstallIconPacksPackageManager
		= "You can also install icon packs later in the package manager";
	...
	public string NeverInstallDLLFiles
		= "Never install .dll files from sources you don't trust! .dll files from unknown sources may harm your system, only install it when you know what you do! Do you really like to install a .dll plugin?";

	public string XWillBeUninstalled = "{0} will be uninstalled.";

	public string XSuccessfullyUninstalled
		= "{0} will be uninstalled. Macro Deck must be restarted to take the changes effect. Restart Macro Deck now?";
	...
	public string IconImportQualityInfo
		= "High quality icons can lead to an increase of memory usage and loading times especially when using many big animated gifs. \n\r\n\rFor gifs it is recommended to use the low or the lowest preset.";
	...
	public string PluginCouldNotBeLoaded
		= "Plugin could not be loaded. Perhaps the installed version of this plugin is not compatible with this version of Macro Deck.";
	...
	public string ShouldMacroDeckBlockConnectionsFromX
		= "Should Macro Deck automatically block future connections from {0}?";

	public string FailedToStartServer
		= "Failed to start the server. Perhaps the configured port is already in use or you set the incorrect network adapter. Confirm you set the correct network adapter in the settings and try to change the port.";

	public string ErrorWhileLoadingPlugins = "Error while loading plugins";

	public string PluginXCouldNotBeLoaded
		= "{0} version {1} could not be loaded.Perhaps it is not compatible with this version of Macro Deck. Actions that uses this plugin, will not work until the plugin is updated.";
	...
	public string PluginXCouldNotBeInstalled
		= "{0} could not be installed. Perhaps it is not compatible with this version of Macro Deck";
	...
	public string WarningDevVersions
		= "Dev versions can be really instable and can cause crashes or data loss (configured action buttons, folders and profiles). You really want to enable the Dev update channel?";

	public string WarningBetaVersions
		= "Beta versions can sometimes be instable and can cause crashes. You really want to enable the Beta update channel?";
	...
	public string ErrorWhileLoadingPackageManager
		= "Error while loading package manager. Perhaps you are not connected to the internet or Macro Deck is blocked by your firewall.";
	...
	public string ActionChangeFolderDescription
		= "Change the current folder on the current device to the configured folder";

	public string ActionGoToParentFolder = "Go to parent folder";

	public string ActionGoToParentFolderDescription
		= "Change the current folder on the current device to the folders parent folder";

	public string ActionGoToRootFolder = "Go to root folder";

	public string ActionGoToRootFolderDescription
		= "Change the current folder on the current device to the root folder";

	public string PluginMacroDeckVariables = "Macro Deck variables";
	public string ActionChangeVariableValue = "Change variable value";

	public string ActionChangeVariableValueDescription
		= "Count up, count down, set a variable value and toggle variable value";
	...
	public string MacroDeckUsesCottleTemplateEngine
		= "Macro Deck uses the Cottle template engine. Click here for more information.";
	...
	public string BindableVariableInfo
		= "The state of this button can be bound to the variable {0}. Do you want to bind the state?";
