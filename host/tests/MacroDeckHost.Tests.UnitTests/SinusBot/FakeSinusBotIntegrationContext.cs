...
internal sealed class FakeSinusBotIntegrationContext : IIntegrationContext
{
	public FakeSinusBotIntegrationConfig ConfigStore { get; } = new();
...
internal sealed class FakeSinusBotIntegrationConfig : IIntegrationConfig
{
