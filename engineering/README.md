...
Public plugin and SDK documentation belongs in the Starlight site under [`docs/`](../docs/).

Keep engineering documentation concise. Document architecture, workflows, contracts, decisions, and non-obvious constraints. Link to implementation files instead of restating their contents.