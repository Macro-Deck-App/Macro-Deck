...
The config flow types, step and field shapes, and OAuth details are documented in full in the [capabilities reference](https://docs.macro-deck.app/features/) and the [SDK reference](https://docs.macro-deck.app/reference/sdk-packages/).
