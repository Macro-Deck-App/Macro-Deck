...
See [Logging in the SDK reference](https://docs.macro-deck.app/sdk/#logging) for the full surface.
...
The config flow types, step and field shapes, and OAuth details are documented in full in the [capabilities reference](https://docs.macro-deck.app/sdk/capabilities/) and the [SDK reference](https://docs.macro-deck.app/sdk/).

---

## Step 5: Variables, actions, icons, and issues

Short pointers; the mechanics of each are in the [capabilities reference](https://docs.macro-deck.app/sdk/capabilities/).
